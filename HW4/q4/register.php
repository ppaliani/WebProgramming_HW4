...
<body>
    ...
    if ($idRows == 0) {
        $insertQuery = "INSERT INTO `users`(`id`, `password`, `name`, `email`, `visits`, `last`) VALUES ('$user_id','$password','$name','$email','$default_visits','$default_last')";
        mysqli_query($db,$insertQuery);
        header("Location: http://localhost:8000/in-class-demo/q4/confirmation.html");
        exit();
    }
